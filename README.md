...
## Future Improvements
- Database integration to store transcriptions
- Refactor monolith into microservices (audio processing / model inference / WebSocket / REST API separation)
- Improve silence detection handling
- Improve latency
